  ...
  <>
    ...
    <div className="border-t-4 border-line relative flex flex-wrap bg-back-light p-4 lg:p-8 bg-no-repeat text-sm mb-6">
      ...
      <div className="lg:flex-1">
        ...
        <span>&nbsp;&nbsp;</span>
        {'https://appetize.io/app/hzmvauxece1anb9b0ewzhquj58?device=iphone11promax&scale=75&orientation=portrait&osVersion=13.3' && (
          <a
            className="text-front underline break-all hover:opacity-75 transition-opacity duration-150"
            href={'https://appetize.io/app/hzmvauxece1anb9b0ewzhquj58?device=iphone11promax&scale=75&orientation=portrait&osVersion=13.3'}
            rel="noreferrer noopener"
            target="_blank"
          >
             live
